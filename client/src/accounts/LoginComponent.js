        ...
        <div className="Acc_logBox">
          ...
          <form className="Acc_formBox px-8 pt-6 pb-8 mb-4">
            ...
            <div className="mb-4 Acc_boxInputLog">
              <input value={email} onChange={inputValue('email')} className={`Acc_inputLogin ${(wrongEmailPass || errorEmailrequire || errorEmail) && 'borderRed'}`} id="email" type="text" placeholder="Email Address" maxLength="30" />
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="" className={`Acc_iconLog ${(wrongEmailPass || errorEmailrequire || errorEmail) && 'AccRed'}`}>
