...
const _MenuComponent = () => {
  ...
  return (
    ...
    <div className='mobileViewport unselectable'
      style={{ 'fontFamily': `${themeSetup.body.bodyFontFamily} , serif` }}
                ...
                {clientData.timeSetup?.timeType && (
                  <div
                    ...
                    {counttype > 1 && <div>{switchManuBtn ? <svg width="10" height="5" viewBox="0 0 46 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <line x1="23.1213" y1="2" x2="44" y2="22.8787" stroke={themeSetup.navAndFootBar.navBarFontColor} stroke-width="3" stroke-linecap="round" />
                      <line x1="1.5" y1="-1.5" x2="31.0269" y2="-1.5" transform="matrix(-0.707107 0.707107 0.707107 0.707107 25 2)" stroke={themeSetup.navAndFootBar.navBarFontColor} stroke-width="3" stroke-linecap="round" />
                    </svg>
                      : <svg width="10" height="5" viewBox="0 0 46 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <line x1="1.5" y1="-1.5" x2="31.0269" y2="-1.5" transform="matrix(0.707107 -0.707107 -0.707107 -0.707107 21 23)" stroke={themeSetup.navAndFootBar.navBarFontColor} stroke-width="3" stroke-linecap="round" />
                        <line x1="22.8787" y1="23" x2="2" y2="2.12132" stroke={themeSetup.navAndFootBar.navBarFontColor} stroke-width="3" stroke-linecap="round" />
                      </svg>
                    }</div>}
                  </div>
                )}
                  ...
                  <div className='navFilterNameText '>
                    ...
                    <div className='filterBtn-main'>
                      {iconFilter === 'food_name' && <svg width="21" height="21" viewBox="0 0 54 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1 5.375H9.75" stroke={themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M31.625 5.375H52.625" stroke={themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M1 22.875H31.625" stroke={themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M44.75 22.875H52.625" stroke={themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M1 40.375H9.75" stroke={themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M22.875 40.375H52.625" stroke={themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M18.5 9.75H14.125C11.7088 9.75 9.75 7.7912 9.75 5.375C9.75 2.9588 11.7088 1 14.125 1H18.5C20.9162 1 22.875 2.9588 22.875 5.375C22.875 7.7912 20.9162 9.75 18.5 9.75Z" stroke={themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                      ...
                      {iconFilter === 'vetgeterian' && <svg width="25" height="25" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g mask="url(#mask0_61_54)">
                          ...
                          <path d="M46.6389 9.36112L9.36108 46.6389" stroke={themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                      ...
                      {iconFilter === 'vegan' && <svg width="25" height="25" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g mask="url(#mask0_61_69)">
                          ...
                          <path d="M18.8532 31.2888C22.7917 31.9281 27.0186 35.8296 28.1363 39.8913" stroke={themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                          <path d="M40.4721 18.1785C41.3423 16.5551 42.6426 15.2333 44.1332 14.1679" stroke={themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                          ...
                          <path d="M32.3594 20.1878C32.3594 20.1878 28.2921 22.192 28.2921 29.8334V45.3916" stroke={themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                        </g>
                      </svg>}
                      {iconFilter === 'gluten_free' && <svg width="25" height="25" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g mask="url(#mask0_61_11)">
                          ...
                          <path d="M28 24.0811V47.7969" stroke={themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                          <path d="M54.3594 28C54.3594 42.5579 42.5579 54.3594 28 54.3594C13.4421 54.3594 1.64062 42.5579 1.64062 28C1.64062 13.4421 13.4421 1.64062 28 1.64062C42.5579 1.64062 54.3594 13.4421 54.3594 28Z" stroke={themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                          <path d="M19.1068 19.1068L9.36134 9.36134" stroke={themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                          <path d="M46.6386 46.6386L37.6031 37.6031" stroke={themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                          <path d="M28.0526 28.0526L28.0001 28.0001L27.9409 27.9409" stroke={themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                        </g>
                      </svg>}
                      {iconFilter === 'halal' && <svg width="25" height="25" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g mask="url(#mask0_61_38)">
                          ...
                          <path d="M20.6047 18.8105V30.9519C20.6047 33.3095 18.6936 35.2206 16.3361 35.2206C13.7667 35.2206 11.7795 32.9671 12.1009 30.4178L12.3997 28.0493" stroke={themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                          <path d="M20.6047 21.3396L23.4032 23.0255C25.3027 24.1698 26.6673 26.0246 27.1946 28.1784" stroke={themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                    ...
                    <div className={`filterBtn-Ab ${!switchFilterBtn && 'filterBtn-move'}`}>
                      ...
                      <div
                        ...
                        <svg width="10" height="10" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <line x1="2.12132" y1="2" x2="23" y2="22.8787" stroke={themeSetup.navAndFootBar.navBarFontColor} stroke-width="3" stroke-linecap="round" />
                          <line x1="1.5" y1="-1.5" x2="31.0269" y2="-1.5" transform="matrix(-0.707107 0.707107 0.707107 0.707107 25 2)" stroke={themeSetup.navAndFootBar.navBarFontColor} stroke-width="3" stroke-linecap="round" />
                        </svg>
                        &nbsp;Clear filter
                      </div>
