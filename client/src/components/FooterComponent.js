                ...
                <svg width="56" height="25" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g clip-path="url(#clip0_6_52)">
                    <g mask="url(#mask0_6_52)">
                      ...
                      <path d="M7.8344 9.58792H23.6162" stroke={prop.themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M11.6789 13.091C13.038 16.1185 15.7715 20.4875 20.9859 23.6162" stroke={prop.themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M20.9859 9.58793C20.9859 9.58793 19.2324 18.3557 10.4647 23.6161" stroke={prop.themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M15.7253 9.58792V7.83442" stroke={prop.themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M34.0447 48.1656L39.9707 32.6061C40.0918 32.31 40.5109 32.3096 40.6325 32.6055L46.5047 48.1656" stroke={prop.themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M35.8928 44.2905H44.6864" stroke={prop.themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M20.1093 45.5353H16.6021C13.2124 45.5353 10.4647 42.7875 10.4647 39.398V34.1377" stroke={prop.themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M18.3556 42.905L21.8626 45.5353L18.3556 48.1656" stroke={prop.themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M35.8907 10.4647H39.3979C42.7876 10.4647 45.5353 13.2125 45.5353 16.6021V21.8623" stroke={prop.themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M37.6444 13.095L34.1374 10.4647L37.6444 7.83438" stroke={prop.themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                    </g>
                  </g>
                  <defs>
          ...
          <div onClick={() => switcher('commentTab')} className="footBarGrid3_3 ">
            ...
            <button className={`footbatBtnCommentt`}>
              ...
              <svg width="57" height="25" viewBox="0 0 57 59" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M40.627 4.13193H9.96215C5.56475 4.13193 2 8.90809 2 14.7999V27.0779C2 32.9697 5.56475 37.7458 9.96215 37.7458H47.2981L53.0126 45.8909H55.2427L55.2427 19.7915C55.2427 18.0513 53.1844 14.4569 52.6327 13.0057" stroke={prop.themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" />
                <path d="M9.30782 17.7036H28.9941" stroke={prop.themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" />
                <path d="M9.30782 25.0114H29.5664" stroke={prop.themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" />
                <path d="M53.8565 2.22101C52.2285 0.592998 49.5889 0.592998 47.9609 2.22101L31.6516 18.5143V24.4259L37.5604 24.4127L53.8565 8.11659C55.4845 6.48858 55.4845 3.84902 53.8565 2.22101Z" stroke={prop.themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" />
                <path d="M43.7589 6.21986L49.5962 12.0571" stroke={prop.themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" />
                <path d="M28.5752 45.7675L30.932 48.7328L34.4805 50.0578L32.3886 53.2157L32.2248 57L28.5752 55.9863L24.9256 57L24.7618 53.2157L22.6699 50.0578L26.2185 48.7328L28.5752 45.7675Z" stroke={prop.themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" />
                <path d="M7.9052 45.7675L10.2621 48.7328L13.8105 50.0578L11.7186 53.2157L11.5549 57L7.9052 55.9863L4.25557 57L4.0919 53.2157L2 50.0578L5.54845 48.7328L7.9052 45.7675Z" stroke={prop.themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" />
                <path d="M49.2452 45.7675L51.602 48.7328L55.1504 50.0578L53.0585 53.2157L52.8949 57L49.2452 55.9863L45.5955 57L45.4318 53.2157L43.3399 50.0578L46.8884 48.7328L49.2452 45.7675Z" stroke={prop.themeSetup.navAndFootBar.navBarFontColor} stroke-width="2" stroke-miterlimit="10" />
              </svg>
            </button>
