    ...
    <div className="sectionNavigation">
      <div className="section1">
        <button onClick={() => {
          ...
          checkOnOff('qrCode')
        }} className="iconBarcode" name='qrCode'>
      ...
      <div className="section2">
        ...
        <button onClick={() => {
          ...
          <svg className={`myIconMd ${avtiveIconWhite == 'menuLang' && 'activeLang'}`} width="35" height="35" viewBox="0 0 65 65" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path fillRule="evenodd" clipRule="evenodd" d="M52.6877 15.5149C53.2332 15.9181 53.7551 16.3513 54.251 16.8122C55.6033 15.6483 56.8742 14.2667 58.2593 12.6507L56.7408 11.3491C55.2866 13.0456 54.0155 14.4117 52.6877 15.5149ZM25.911 21.92C26.2538 21.2388 26.6385 20.5824 27.0619 19.9541C22.0067 19.8238 18.4875 19.4 15.7537 18.4887C12.4345 17.3823 10.2115 15.5347 7.79265 12.3902L6.2074 13.6096C8.78859 16.9652 11.3155 19.1175 15.1213 20.3861C17.905 21.314 21.337 21.7556 25.911 21.92Z" fill="#777777" />
            <path fillRule="evenodd" clipRule="evenodd" d="M29.5725 44.0215C22.4536 44.1527 18.1654 44.8792 15.0377 46.0649C12.3006 47.1025 10.4701 48.498 8.51284 49.9901C7.99445 50.3853 7.46717 50.7873 6.9118 51.1912L8.08814 52.8087C8.71597 52.3521 9.28695 51.9176 9.82919 51.5051L9.82924 51.505C11.7465 50.0463 13.3046 48.8608 15.7466 47.935C18.8732 46.7498 23.4783 46 32 46C32.0155 46 32.0311 46 32.0466 46C31.1641 45.4132 30.3363 44.7506 29.5725 44.0215ZM48.326 47.8569C49.4615 48.3351 50.4715 48.9196 51.5844 49.6373C52.0834 49.959 52.6236 50.3219 53.211 50.7163L53.2112 50.7165L53.2113 50.7165C54.1649 51.357 55.2428 52.0809 56.47 52.8479L57.53 51.1519C56.3061 50.387 55.3125 49.7188 54.3956 49.1022L54.3955 49.1021C53.8014 48.7026 53.2396 48.3248 52.6683 47.9564C52.004 47.5281 51.3554 47.1325 50.6825 46.7712C49.9284 47.1873 49.1412 47.5509 48.326 47.8569Z" fill="#777777" />
            <path fillRule="evenodd" clipRule="evenodd" d="M37.2069 61.1537L37.2069 61.1536C38.4624 58.7433 39.5073 56.7372 40.3177 53.6132C40.7183 52.0692 41.06 50.2515 41.3287 47.9876C41.5515 47.9958 41.7753 47.9999 42 47.9999C42.4529 47.9999 42.902 47.9832 43.3465 47.9503C43.0641 50.4179 42.6959 52.4108 42.2537 54.1154C41.3814 57.4778 40.2147 59.715 38.9393 62.1605L38.9392 62.1607C38.5978 62.8153 38.2487 63.4849 37.8952 64.195L36.1047 63.3039C36.4882 62.5333 36.8558 61.8277 37.2069 61.1537ZM42.3451 12.0032C41.6718 9.61996 40.7707 7.6599 39.6618 5.24807L39.6617 5.24797C39.1283 4.08773 38.5468 2.82294 37.9194 1.3562L36.0806 2.14269C36.7671 3.74787 37.3777 5.07505 37.9215 6.25688L37.9215 6.25697C38.9137 8.41356 39.6832 10.0861 40.2851 12.0806C40.8495 12.0272 41.4216 11.9999 42 11.9999C42.1153 11.9999 42.2304 12.001 42.3451 12.0032Z" fill="#777777" />
          </svg>
      ...
      <div className="endSection">
        ...
        <button className="">
          <svg width="35" height="35" viewBox="0 0 65 65" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M56.413 11.5472C56.9652 11.5472 57.413 11.0995 57.413 10.5472V1.54721C57.413 0.994924 56.9652 0.547208 56.413 0.547208C55.8607 0.547208 55.413 0.994924 55.413 1.54721V9.54721H47.413C46.8607 9.54721 46.413 9.99493 46.413 10.5472C46.413 11.0995 46.8607 11.5472 47.413 11.5472H56.413ZM54.2221 9.77058L55.7059 11.2543L57.1201 9.8401L55.6363 8.35637L54.2221 9.77058Z" fill="#777777" />
            <path fillRule="evenodd" clipRule="evenodd" d="M32.5 63C49.3447 63 63 49.3447 63 32.5C63 32.333 62.9987 32.1663 62.996 32H64.9962C64.9987 32.1664 65 32.333 65 32.5C65 50.4493 50.4493 65 32.5 65C14.5507 65 0 50.4493 0 32.5C0 14.5507 14.5507 0 32.5 0C41.2434 0 49.1804 3.45267 55.022 9.06896L53.5867 10.4636C48.1093 5.22081 40.6808 2 32.5 2C15.6553 2 2 15.6553 2 32.5C2 49.3447 15.6553 63 32.5 63Z" fill="#777777" />
            ...
            <path fillRule="evenodd" clipRule="evenodd" d="M18 28H48V50H18V28ZM34.5 38.5986C35.3967 38.0799 36 37.1103 36 36C36 34.3433 34.6569 33 33 33C31.3431 33 30 34.3433 30 36C30 37.1103 30.6033 38.0799 31.5 38.5986V42C31.5 42.8284 32.1716 43.5 33 43.5C33.8284 43.5 34.5 42.8284 34.5 42V38.5986Z" fill="#777777" />
          </svg>
        </button>
