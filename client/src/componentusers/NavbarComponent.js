    ...
    <div className='sectionNavigation'>
      <div className='section1'>
        <button
          ...
          <svg className={`${prop.onOffQrCode && 'qrCodeActive'}`} width="32" height="32" viewBox="0 0 65 65" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M7 1H26V26H1V7C1 3.68629 3.68629 1 7 1Z" stroke={iconNonActiveColor} strokeWidth="3.5" />
            <rect x="8" y="8" width="11" height="11" rx="2" fill={iconNonActiveColor} />
            <rect x="46" y="8" width="11" height="11" rx="2" fill={iconNonActiveColor} />
            <rect x="8" y="46" width="11" height="11" rx="2" fill={iconNonActiveColor} />
            <rect x="57" y="38" width="8" height="8" rx="1" fill={iconNonActiveColor} />
            <rect x="48" y="57" width="8" height="8" rx="1" fill={iconNonActiveColor} />
            <rect x="57" y="47" width="8" height="8" rx="1" fill={iconNonActiveColor} />
            <rect x="38" y="38" width="8" height="8" rx="1" fill={iconNonActiveColor} />
            <rect x="38" y="57" width="8" height="8" rx="1" fill={iconNonActiveColor} />
            <rect x="48" y="47" width="8" height="8" rx="1" fill={iconNonActiveColor} />
            <path d="M39 1H58C61.3137 1 64 3.68629 64 7V26H39V1Z" stroke={iconNonActiveColor} strokeWidth="3.5" />
            <path d="M1 39H26V64H7C3.68629 64 1 61.3137 1 58V39Z" stroke={iconNonActiveColor} strokeWidth="3.5" />
          </svg>
        </button>
      </div>
      ...
      <div className='section2'>
          ...
          <svg className={`${prop.onOffBanner && 'bannerActive'}`} width="30" height="30" viewBox="0 0 65 65" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_193_199)">
              <g mask="url(#mask0_193_199)">
                <path d="M55.5483 38.185C57.2694 37.1914 57.8591 34.9906 56.8654 33.2695L39.4393 3.08682C38.4457 1.36571 36.2449 0.776018 34.5238 1.76968C32.8028 2.76334 32.2131 4.96408 33.2068 6.68518L50.6328 36.8679C51.6264 38.589 53.8272 39.1787 55.5483 38.185Z" stroke={iconNonActiveColor} strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M17.3648 50.2572C18.8963 49.373 19.4211 47.4147 18.5368 45.8833L9.35141 29.9737C8.46718 28.4421 6.50893 27.9174 4.97737 28.8016C3.44593 29.6859 2.92123 31.6441 3.80546 33.1756L12.9909 49.0852C13.875 50.6168 15.8334 51.1415 17.3648 50.2572Z" stroke={iconNonActiveColor} strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M11.4714 47.2088L11.7985 47.02L4.99771 35.2407L4.67068 35.4295C1.41789 37.3075 0.303366 41.4667 2.18138 44.7195C4.0594 47.9723 8.21864 49.0868 11.4714 47.2088Z" stroke={iconNonActiveColor} strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M25.3382 14.3616L33.3634 6.95645L50.4763 36.5967L18.8609 46.4446L9.02734 29.4122L16.9422 22.1088" stroke={iconNonActiveColor} strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M50.9054 22.947C53.539 21.4265 54.4414 18.0588 52.9209 15.4252C51.4002 12.7915 48.0327 11.8893 45.399 13.4098" stroke={iconNonActiveColor} strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M18.8609 46.4446L28.4738 63.0947C28.8152 63.6858 29.5712 63.8884 30.1624 63.5471L36.0077 60.1723C36.7485 59.7446 36.8414 58.7119 36.1889 58.1589L31.7734 54.4165L26.0057 44.4267" stroke={iconNonActiveColor} strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M57.3383 12.9202L61.6262 10.4446" stroke={iconNonActiveColor} strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M51.1299 7.24512L52.4428 2.34574" stroke={iconNonActiveColor} strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M59.0526 21.1471L63.7309 22.4006" stroke={iconNonActiveColor} strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
              </g>
            </g>
            <defs>
        ...
        <button
          ...
          <svg className={` ${prop.onOffMenuTime && 'activeTime'}`} width="30" height="30" viewBox="0 0 71 71" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="35.5" cy="35.5" r="34" stroke={iconNonActiveColor} strokeWidth="3" />
            <path d="M35.0923 10.9231C35.0923 11.7515 35.7639 12.4231 36.5923 12.4231C37.4207 12.4231 38.0923 11.7515 38.0923 10.9231L35.0923 10.9231ZM35.0923 1.09229L35.0923 10.9231L38.0923 10.9231L38.0923 1.09229L35.0923 1.09229Z" fill={iconNonActiveColor} />
            <path d="M38.0923 16.3848C38.0923 15.5563 37.4207 14.8848 36.5923 14.8848C35.7639 14.8848 35.0923 15.5563 35.0923 16.3848L38.0923 16.3848ZM35.0923 16.3848L35.0923 36.0463L38.0923 36.0463L38.0923 16.3848L35.0923 16.3848Z" fill={iconNonActiveColor} />
            <path d="M51.6135 49.4599C52.271 49.964 53.2126 49.8396 53.7166 49.1822C54.2206 48.5247 54.0963 47.5832 53.4388 47.0791L51.6135 49.4599ZM53.4388 47.0791L37.0542 34.5176L35.2289 36.8984L51.6135 49.4599L53.4388 47.0791Z" fill={iconNonActiveColor} />
            <path d="M38.0923 61.1692C38.0923 60.3408 37.4207 59.6692 36.5923 59.6692C35.7639 59.6692 35.0923 60.3408 35.0923 61.1692L38.0923 61.1692ZM35.0923 61.1692L35.0923 71L38.0923 71L38.0923 61.1692L35.0923 61.1692Z" fill={iconNonActiveColor} />
            <path d="M9.83077 35.9077C10.6592 35.9077 11.3308 35.2361 11.3308 34.4077C11.3308 33.5793 10.6592 32.9077 9.83077 32.9077V35.9077ZM0 35.9077H9.83077V32.9077H0V35.9077Z" fill={iconNonActiveColor} />
            <path d="M61.1692 34.5461C60.3408 34.5461 59.6692 35.2177 59.6692 36.0461C59.6692 36.8746 60.3408 37.5461 61.1692 37.5461V34.5461ZM61.1692 37.5461H71V34.5461H61.1692V37.5461Z" fill={iconNonActiveColor} />
          </svg>
        ...
        <button
          ...
          <svg className={`${prop.onOffLangSetup && 'activeLang'}`} width="30" height="30" viewBox="0 0 71 71" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g mask="url(#mask0_191_198)">
              <path d="M68.9199 35.5C68.9199 53.9574 53.9574 68.9199 35.5 68.9199C17.0426 68.9199 2.08008 53.9574 2.08008 35.5C2.08008 17.0426 17.0426 2.08008 35.5 2.08008C53.9574 2.08008 68.9199 17.0426 68.9199 35.5Z" stroke={iconNonActiveColor} strokeWidth="3" strokeMiterlimit="10" />
              <path d="M9.79156 56.8547C15.9218 53.1687 25.1629 50.8222 35.5001 50.8222C45.8372 50.8222 55.0782 53.1687 61.2085 56.8547" stroke={iconNonActiveColor} strokeWidth="3" strokeMiterlimit="10" />
            </g>
            <path className='activeLangPath' fillRule="evenodd" clipRule="evenodd" d="M35.5 70.4199C30.0115 70.4199 25.4463 66.0096 22.3426 59.8023C19.1941 53.5053 17.29 44.9111 17.29 35.5C17.29 26.0889 19.1941 17.4947 22.3426 11.1977C25.4463 4.99044 30.0115 0.580078 35.5 0.580078C39.2954 0.580078 42.6493 2.68905 45.3836 6.04281C44.9261 6.01441 44.4647 6 44 6C43.1141 6 42.2405 6.05236 41.382 6.15416C39.4973 4.45086 37.4916 3.58008 35.5 3.58008C31.7599 3.58008 27.9701 6.651 25.0259 12.5393C22.1266 18.338 20.29 26.4537 20.29 35.5C20.29 44.5463 22.1266 52.662 25.0259 58.4607C27.9701 64.349 31.7599 67.4199 35.5 67.4199C39.2401 67.4199 43.03 64.349 45.9741 58.4607C47.2738 55.8614 48.3599 52.7965 49.1627 49.3909C50.3021 49.1169 51.4069 48.7542 52.4694 48.3106C51.598 52.6244 50.2963 56.5246 48.6574 59.8023C45.5538 66.0096 40.9886 70.4199 35.5 70.4199Z" fill={iconNonActiveColor} />
            <path className='activeLangPath' fillRule="evenodd" clipRule="evenodd" d="M37 48.863V68.9199H34V47.6012C34.9612 48.0925 35.9634 48.5153 37 48.863ZM37 7.13704V2.08008H34V8.39884C34.9612 7.90746 35.9634 7.4847 37 7.13704Z" fill={iconNonActiveColor} />
            <path className='activeLangPath' fillRule="evenodd" clipRule="evenodd" d="M22.8281 34H2.08008V37H23.9192C23.486 36.0349 23.1203 35.0329 22.8281 34ZM64.0808 37H68.9199V34H65.1719C64.8797 35.0329 64.514 36.0349 64.0808 37Z" fill={iconNonActiveColor} />
            <path className='activeLangPath' fillRule="evenodd" clipRule="evenodd" d="M23.2915 20.5554C23.6416 19.5816 24.0585 18.6395 24.5366 17.7348C18.9895 16.7458 14.1795 15.0332 10.5645 12.8596L9.01862 15.4306C12.8294 17.722 17.7333 19.4936 23.2915 20.5554ZM61.6044 14.8036L60.4355 12.8596C60.3349 12.9201 60.2334 12.9802 60.1309 13.04C60.6518 13.6014 61.1438 14.1901 61.6044 14.8036Z" fill={iconNonActiveColor} />
            <path className='activeLangPath' d="M55.524 30.3184V38H36.276V34.9238L39.0006 34.3965V16.0273L36.276 15.5V12.4062H47.2271V15.5L44.1334 16.0273V34.0625H51.358L51.6041 30.3184H55.524Z" fill={iconNonActiveColor} />
          </svg>
        ...
        <button
          ...
          <svg className={`${prop.onOffTheme && 'bannerActive'}`} width="30" height="30" viewBox="0 0 65 65" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g mask="url(#mask0_194_225)">
              <path d="M31.403 6.35694C30.1748 6.18085 28.9281 6.09033 27.6707 6.08843C13.09 6.06583 1.24671 17.8955 1.26956 32.459C1.29216 47.0224 13.1723 58.8889 27.753 58.9116C35.5189 58.9236 42.8603 55.539 47.8951 49.6261C48.0977 49.3881 48.2396 49.0643 48.3345 48.691C48.9622 46.2219 47.0266 43.8374 44.479 43.8374H40.5593C37.4686 43.8374 34.9633 41.3321 34.9633 38.2415C34.9633 35.151 37.4686 32.6456 40.5593 32.6456C48.3431 31.437 52.2882 22.5864 47.9681 15.9995C47.255 14.9123 46.4956 13.9523 45.6987 13.2101C44.8514 12.421 43.96 11.6928 43.0307 11.0278" stroke={iconNonActiveColor} strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M37.3391 13.2872C39.0715 14.8255 39.2321 17.4717 37.697 19.1979C36.1622 20.9239 33.5132 21.0764 31.7808 19.5383C30.0478 18 29.8874 15.354 31.4224 13.6273C32.957 11.9011 35.6062 11.7489 37.3391 13.2872Z" stroke={iconNonActiveColor} strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M20.8884 12.053C23.199 11.9201 25.1853 13.6831 25.3255 15.9916C25.4653 18.3001 23.7058 20.2788 21.395 20.4119C19.0844 20.5449 17.0983 18.7816 16.9581 16.473C16.818 14.1649 18.5778 12.186 20.8884 12.053Z" stroke={iconNonActiveColor} strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M8.41716 22.796C9.95164 21.07 12.6005 20.9174 14.3337 22.4557C16.0662 23.9941 16.2266 26.6404 14.6918 28.3665C13.1568 30.0928 10.5082 30.2449 8.77517 28.707C7.04226 27.1686 6.88179 24.5224 8.41716 22.796Z" stroke={iconNonActiveColor} strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M7.22969 39.2239C7.09005 36.9155 8.84924 34.9365 11.1599 34.8034C13.4707 34.6706 15.4573 36.4341 15.597 38.7423C15.7368 41.0507 13.9775 43.0294 11.6671 43.1623C9.35616 43.2956 7.3696 41.5324 7.22969 39.2239Z" stroke={iconNonActiveColor} strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M18.0227 51.713C16.2902 50.1747 16.1295 47.5289 17.6643 45.8023C19.1992 44.0765 21.8481 43.9241 23.581 45.4621C25.3133 47.0004 25.4739 49.6467 23.9391 51.3727C22.4043 53.0988 19.7554 53.2512 18.0227 51.713Z" stroke={iconNonActiveColor} strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M61.3221 42.0969C61.6713 40.2156 61.9303 37.9815 62.0694 35.5299C62.1447 34.2008 62.1848 30.0874 62.1848 28.6521C62.1848 19.4289 60.53 9.23156 58.4886 9.23156C56.4472 9.23156 54.7922 19.4289 54.7922 28.6521C54.7922 30.0874 54.8325 34.2008 54.9079 35.5299C55.0468 37.9814 55.3059 40.2155 55.655 42.0968" stroke={iconNonActiveColor} strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M53.2466 46.9053C53.2466 46.2789 53.3566 45.6782 53.5582 45.1214C54.2913 43.0965 56.2661 41.7879 58.4197 41.7879H58.5573C60.711 41.7879 62.6857 43.0965 63.4189 45.1214C63.6205 45.6781 63.7304 46.2788 63.7304 46.9053C63.7304 52.205 58.4882 55.6414 58.4882 55.6414C58.4882 55.6414 58.4174 55.5935 58.2925 55.5008C57.4144 54.8489 53.8625 51.9835 53.3175 47.9461C53.271 47.6075 53.2466 47.2603 53.2466 46.9053Z" stroke={iconNonActiveColor} strokeWidth="3" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
            </g>
          </svg>
      ...
      <div className="mobile-creator unselectable">
        {/* <div className="MC_nav">
          ...
          <div className="MC_Tab MC_Tab_4">X</div>
