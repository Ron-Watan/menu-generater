...
import Subfoosa from "./SubAddFood"
...
const MainForm = () => {
  ...
  // const inputValueMenu = (e, id) => {
  //   console.log(e.target.value)
  //   var result = [...manuList];
  //   result = result.map((x) => {
  //     if (x.id === id) {
  //       x.food_name = e.target.value;
  //       return x;
  //     } else return x;
  //   });
  //   setMenuList(result);
  ...
  const inputValueMenu = (name) => (even) => {
    console.log(name, even.target.value)
  ...
  const inputValueMenu1 = (e, id, name) => {
    // console.log(e.target.value)
    // var result = [...manuList];
  
     setMenuList({ ...manuList, [name]: e.target.value })
      ...
      <div className="formContainer">
              ...
              <div className={`classes.Roomview`}>
                ...
                >
                  {/* <input
                    ...
                    onChange={(e) => inputValueMenu1(e, el.id)}
                  /> */}


                  <div className="mt-2">
                    <input onChange={(e) => inputValueMenu1(e, el.id, "food_name")} value={el.food_name} type="text" name="food_name" id="food-name" autoComplete="given-name" className="block w-full rounded-md border-1 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                  </div>
                  <div className="mt-2">
                    <textarea onChange={(e) => inputValueMenu1(e, el.id, "description")} value={el.description} id="description" name="description" rows="3" className="xBorder block w-full rounded-md border-1 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
                  </div>
                </div>
        ...
        <form className="formMenu">
          ...
          <div className="layoutManu">
            ...
            {manuList.map(el => {
              return (<div className="layoutManu0" >
                <div className="layoutManu1">

                  <i className="sr-only">!FOOD NAME</i>
                  <div className="sm:col-span-3" key={el.id}>
                    <label htmlFor="food_name" className="block text-sm font-medium leading-6 text-gray-900">First name</label>
                    <div className="mt-2">
                      <input onChange={inputValueMenu(el.food_name)} value={el.food_name} type="text" name="food_name" id="food-name" autoComplete="given-name" className="block w-full rounded-md border-1 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                    </div>
                  </div>
                  ...
                  {/* <div className="col-span-full">
                    ...
                    <div className="mt-2">
                      <textarea onChange={inputValueMenu(el.id)} value={el.description} id="description" name="description" rows="3" className="xBorder block w-full rounded-md border-1 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
                    </div>
                  ...
                  {/* <div className="sm:col-span-3">
                    ...
                    <div className="mt-2">
                      <input onChange={inputValueMenu(el.id)} value={el.remark} type="text" name="remark" id="remark" autoComplete="given-name" className="block w-full rounded-md border-1 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                    </div>
                  </div> */}
                  ...
                  {/* <div>
                    ...
                    <div className="relative mt-2 rounded-md shadow-sm">
                      ...
                      <input onChange={inputValueMenu(el.id)} value={el.price} type="text" name="price" id="price" className="block w-full rounded-md border-0 py-1.5 pl-7 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="0.00" />
