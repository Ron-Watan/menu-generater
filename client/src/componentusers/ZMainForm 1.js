...
const MainForm = () => {
  ...
  const fileUploader = () => {
    ...
    formData.append('image', stateUp.file, stateUp.file.name);

    axios
      .post(`${process.env.REACT_APP_API}/user/file`, formData)
      .then((res) => {
        const data = res.data;
        // console.log(data);
                    ...
                    <div className="">
                      <div className="">
                        <textarea onChange={event => inputListValue(index, event)} value={el.remark}
                          ...
                          className="inputText fontXSmall italic testAreaR" placeholder="Remark (optional)" />
                      </div>
                    </div>
                    ...
                    <div className="flex">
                      ...
                      <div className=" ">
                        <input onChange={event => inputListValue(index, event)} value={el.price}
                          ...
                          className="inputTextFood fontCat" pattern="[0-9]*.\d{0,2}" placeholder="0" />
                      </div>
                    </div>
                          ...
                          <label htmlFor={`vetgeterian_${index}`} className="relative flex gap-x-2">
                            <div className="flex h-6 items-center">
                              <input onChange={event => {
                                ...
                                value={'vetgeterian'} id={`vetgeterian_${index}`} checked={el.vetgeterian} name="vetgeterian" type="checkbox" className="hideCheckBox cursor-pointer  h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600" />
                          ...
                          <label htmlFor={`vegan${index}`} className="relative flex gap-x-2">
                            <div className="flex h-6 items-center">
                              <input onChange={event => {
                                ...
                                value={'vegan'} id={`vegan${index}`} checked={el.vegan} name="vegan" type="checkbox" className="hideCheckBox cursor-pointer h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600" />
                          ...
                          <label htmlFor={`gluten_free${index}`} className="relative flex gap-x-2">
                            <div className="flex h-6 items-center">
                              <input onChange={event => {
                                ...
                                value={'gluten_free'} id={`gluten_free${index}`} checked={el.gluten_free} name="gluten_free" type="checkbox" className="hideCheckBox cursor-pointer h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600" />
                          ...
                          <label htmlFor={`halal${index}`} className="relative flex gap-x-2">
                            <div className="flex h-6 items-center">
                              <input onChange={event => {
                                ...
                                value={'halal'} id={`halal${index}`} checked={el.halal} name="halal" type="checkbox" className="hideCheckBox cursor-pointer h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600" />
