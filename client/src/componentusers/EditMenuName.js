    ...
    <div className="menuNameBox" name='menuNameBox'>
      ...
      <div className={`flexNameMenu`}>
        <input onChange={inputMenuTimeName} value={prop.menuName[currentMenuName]} type='text' maxLength="20"
          disabled={!prop.activeInputEn ? true : false} name='' id='menuName' autoComplete='off' className='inputMenuName inputMenuName_edname' placeholder='' />
        <div className={`iconEditName_SC ${prop.activeInputEn ? 'showMe' : 'hiddenMe'}`}
          name='menuNameBox'>
          <button onClick={() => {
            saveNameMenu()
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="#aaa" className="w-5 h-5 iconEDName_SC">
