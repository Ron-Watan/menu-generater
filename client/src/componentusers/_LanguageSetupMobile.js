...
const _LanguageSetupMobile = (prop) => {
  ...
  return (
    ...
    <div className=''>
      ...
      <div className='MB_windowFloatLangBorder'>
        <div className=''>
                    ...
                    <label htmlFor='MB_Styled' className='MB_LangRadioBtn'>
                      ...
                      <label htmlFor='MB_followed1' className={`containerSwitch switchLang ${!languageSetup.style_1 && 'opcaityTime'}`}>
                        <input onChange={styleSymboleFn2('followed_1')} disabled={!languageSetup.style_1}
                          type='checkbox' name='MB_followed1' id='MB_followed1' /> <span className='sliderLang'></span>
                      </label>
                    </label>
                  ...
                  <div className='flexStyleBeAf'>
                    ...
                    <label htmlFor='MB_Styled2' className='MB_LangRadioBtn'>
                      ...
                      <label htmlFor='MB_followed2' className={`containerSwitch switchLang ${!languageSetup.style_2 && 'opcaityTime'}`}>
                        <input onChange={styleSymboleFn2('followed_2')} disabled={!languageSetup.style_2 || !languageSetup.onLanguage_2} type='checkbox' name='MB_followed2' id='MB_followed2' /> <span className='sliderLang'></span>
                      </label>
...
export default _LanguageSetupMobile;
