...
const MainForm = () => {
  ...
  const getImage = (imgId) => {
    axios
      ...
      .then((result) => {
        if (!result.data.images) return setFile('')
  ...
  const chooseMenu = (oneMennu) => {
    ...
    // console.log(oneMennu.listMenu[0].food_name)

    // setListMenu([{
    //   food_name: oneMennu.listMenu[0].food_name,
    //   description: oneMennu.listMenu[0].description,
    //   remark: oneMennu.listMenu[0].remark,
    //   price: oneMennu.listMenu[0].price,
    //   vetgeterian: oneMennu.listMenu[0].vetgeterian,
    //   vegan: oneMennu.listMenu[0].vegan,
    //   gluten_free: oneMennu.listMenu[0].gluten_free,
    //   halal: oneMennu.listMenu[0].halal,
    //   favor: oneMennu.listMenu[0].favor,
    // }])
  ...
  return (
    ...
    <div>
      {loading && (<div className="loadering z-100">
