          ...
          <div className="H_Banner">
            ...
            <div className='H_featureSection'>
              ...
              <div className="FT-QRCode H_BannerM_Flex " >
                ...
                <div className="H_BannerM_Flex2 H_boxFeature">
                  ...
                  <div className="H_boxFeatureText">
                    ...
                    <div className="">
                      ...
                      <div id='feature2' className="Ftsmall">min. 3 cm. to max. 100 cm.</div>
                    </div>
              ...
              <div className="FT-Banner H_BannerM_Flex " >
                ...
                <div className="H_BannerM_Flex2 H_boxFeature">
                  ...
                  <div className="hiddenMe" id='feature3'></div>
                </div>
              ...
              <div className="FT-Menu H_BannerM_Flex " >
                <div className=" H_BannerM_Flex1_FT">
                ...
                <div className="H_BannerM_Flex2 H_boxFeature">
                  ...
                  <div className="H_boxFeatureText">
                    ...
                    <div className="">
                      ...
                      <div id='feature4' className="Ftsmall">or auto from web browser</div>
              ...
              <div className="FT-Feedback H_BannerM_Flex " >
                  ...
                  <div className="H_boxFeatureText">
                    ...
                    <div className="">
                      ...
                      <div className="Ftsmall">
                        ...
                        <div id='feature5' className="">Avarage and Summary rating</div>
              ...
              <div className="FT-Time H_BannerM_Flex ">
                <div className=" H_BannerM_Flex1_FT">
                  ...
                  <div className="H_boxFeatureText">
                    ...
                    <div className="">
                      ...
                      <div className="Ftsmall">
                        ...
                        <div id='feature6' className="">will be change automaticlly by your local time</div>
                      </div>
                    </div>
              ...
              <div className="FT-Lang H_BannerM_Flex H_BannerM_Flex_FT">
                  ...
                  <div className="H_boxFeatureText">
                    ...
                    <div className="">
                      ...
                      <div className="Ftsmall">
                        ...
                        <div id='feature7' className="">Determine Currency style and Symbole</div>
              ...
              <div className="FT-Contact H_BannerM_Flex ">
                <div className=" H_BannerM_Flex1_FT">
                  <img className="H_BoxImg_FT" src={fcontact} alt="" />
                </div>

                <div className="H_BannerM_Flex2 H_boxFeature M_paddingR">
                  ...
                  <div className="H_boxFeatureText">
                    ...
                    <div className="Ftsmall">
                      ...
                      <div className="hiddenMe h_fbanner"></div>
                    <div className="hiddenMe" id='feature8'></div>
                    </div>
              ...
              <div className="FT-Theme H_BannerM_Flex ">
              ...
              <div className="FT-Contact H_BannerM_Flex ">
                ...
                <div className="H_BannerM_Flex2 H_boxFeature M_paddingR">
                  ...
                  <div className="H_boxFeatureText">
                    ...
                    <div className="Ftsmall">&bull; Promotion/Banner</div>
                    <div id='feature9'className="Ftsmall">&bull; BottomBar</div>
                  </div>
